...
latex_documents = [
    (master_doc, 'sqlalchemy.tex', u'sqlalchemy Documentation',
     u'Hugo Xia', 'manual'),
]
...
man_pages = [
    (master_doc, 'sqlalchemy', u'sqlalchemy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sqlalchemy', u'sqlalchemy Documentation',
     author, 'sqlalchemy', 'One line description of project.',
     'Miscellaneous'),
]
